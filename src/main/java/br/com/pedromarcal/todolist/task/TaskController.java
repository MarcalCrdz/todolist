package br.com.pedromarcal.todolist.task;

import br.com.pedromarcal.todolist.utils.Utils;
...
public class TaskController {
   ...
   public ResponseEntity<String> create(@RequestBody TaskModel taskModel, HttpServletRequest request) {
        ...
        String task = String.valueOf(this.taskRepository.save(taskModel));
   ...
   @GetMapping("/")
    ...
    public ResponseEntity update(@RequestBody TaskModel taskModel, HttpServletRequest request, @PathVariable UUID id){
        ...
        if (!task.getIdUser().equals(idUser)) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body("Usuario não tem permissao para atualizar essa tarefa");
        }
